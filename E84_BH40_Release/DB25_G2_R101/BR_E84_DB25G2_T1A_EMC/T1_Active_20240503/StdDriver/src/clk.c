...
uint32_t CLK_EnablePLL(uint32_t u32PllClkSrc, uint32_t u32PllFreq)
{
    ...
    if(u32PllClkSrc == CLK_PLLCON_PLL_SRC_HXT)
    {
        ...
        /* u32NR start from 2 */
	if(u32PllSrcClk == 12000000ul)  u32NR = 2;
	else if(u32PllSrcClk == __HIRC) u32NR = 4;
	else u32NR = 2; //default
    }
...
lexit:
    ...
    if(u32PllClkSrc == CLK_PLLCON_PLL_SRC_HXT)
    {
	if(u32CLK_SRC != __HIRC)  CLK->PLLCON = 0xC22E; /* 48MHz */
	else  CLK->PLLCON = 0xD66F;
    }	
    else
